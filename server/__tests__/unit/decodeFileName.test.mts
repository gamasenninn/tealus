import { decodeFileName } from '../../src/middleware/upload.mts';
...
describe('decodeFileName (multipart latin1 → utf8)', () => {
  ...
  test('handles empty / null / undefined without throwing', () => {
    ...
    expect(decodeFileName(null as unknown as string)).toBe(null);
    expect(decodeFileName(undefined as unknown as string)).toBe(undefined);
  });
