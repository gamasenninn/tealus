...
import { runStartupEnvCheck, checkOpenAIApiKey, isEmpty, type WarnLogger } from '../../src/utils/envCheck.mts';

function createMockLogger(): WarnLogger & { warn: jest.Mock; info: jest.Mock; error: jest.Mock } {
  return {
    warn: jest.fn(),
    info: jest.fn(),
    error: jest.fn(),
