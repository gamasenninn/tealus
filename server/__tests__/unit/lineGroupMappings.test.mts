...
import { loadGroupToRoomMap, normalizeMap, getGroupMappingMeta } from '../../src/services/lineGroupMappings.mts';

let tmpDir: string;
let tmpFile: string;
let origMappingsEnv: string | undefined;
let origEnvMap: string | undefined;
