...
// ESM では import が巻き上げられ、SUT (deepRegistry.mts) がモジュール読込時に
...
import type { DeepProcess } from '../../src/agents/deepRegistry.mts';

function makeMockProcess(overrides: Record<string, unknown> = {}): DeepProcess {
  ...
  return proc as unknown as DeepProcess;
}
