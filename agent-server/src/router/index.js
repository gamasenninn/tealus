...
const GREETING_PATTERNS = [
  ...
  { pattern: /^(やあ|ヤッホー|よう|ハロー|hello|hi)/i, response: 'こんにちは！今日はどんなお手伝いをしましょうか？' },
];

// Deep キーワード
const DEEP_KEYWORDS = [
  'コード', 'リファクタ', 'デバッグ', 'レビュー', '実装',
  'PR', 'プルリクエスト', 'ファイル作成', 'ファイル編集',
  '分析して', 'レポート作成', '戦略', '設計',
];
...
light: 簡単な質問、検索、翻訳、要約、日常的なタスク（1〜数ステップ）
deep: 複雑な分析、コード生成、ファイル操作、長いワークフロー、戦略立案
