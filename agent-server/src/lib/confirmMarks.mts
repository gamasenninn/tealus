 ...
 *   ★★★ 印の誤報は 29.4% (n=68、2026-09-22 実測) で、★ 信用されなくなる側にある。
 *
 ...
 * ```
 *
 * ★★★ **実測の割れ方** (2026-09-24 / 朝礼+終礼 166 便・語に付いた印 529 箇所):
 * ```
 *   台帳 = dictionary.local.ttl + 末尾の敬称外し
 *     〔要確認・登録済〕 213 (40.3%)  ← ★ 台帳に在るのに印が付いた = 聞き直す側
 *     〔要確認〕のまま    316 (59.7%)  ← ★ 台帳に無い = 登録を検討する側
 *   ★ 台帳を canon (organon.ttl) にすると 234 / 295。**基準を変えると割れ方が変わる**ので、
