...
interface ViewerState {
  images: Array<{ file_path?: string; thumbnail_path?: string | null; file_name?: string | null }>;
  index: number;
}
...
function MediaGallery() {
  ...
  const getDocIcon = (fileName: string | null | undefined) => {
  ...
  const getDocExt = (fileName: string | null | undefined) => {
    const ext = ((fileName || '').split('.').pop() as string).toUpperCase();
    return ext || '';
  };
