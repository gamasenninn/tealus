...
function ChatRoom() {
  ...
  const [callStatus, setCallStatus] = useState<{ state: string; count: number } | null>(null); // { state: 'waiting'|'active', count }
  ...
  useEffect(() => {
    ...
    const handleStatus = (data: CallStatusPayload) => {
