 ...
 */
export function useVoiceContinuousPlay(messages: Message[]): void {
  useEffect(() => {
    ...
    const handleVoiceEnded = (e: Event) => {
      const endedId = (e as CustomEvent<{ messageId: string }>).detail.messageId;
