...
- LINEの画像・動画が個人スマホの容量を圧迫
- Messenger APIが高額で社内システム連携コストが高い
- Slackは社内のITリテラシーの都合で導入困難
...
- **Phase 1（完了）**: MVP — チャット・メディア・既読・リプライ・Push通知・PWA
- **Phase 2**: メッセージ検索、メンション、アルバム機能、スタンプ
- **Phase 3**: AI Bot連携（MCP経由）、音声/ビデオ通話（WebRTC）、LDAP認証
